...
class TrainingArguments(transformers.TrainingArguments):
    ...
    cross_attention_lr: Optional[float] = None
    ...
    def modality_lengths(self):
        ...
        for sample in self.list_data_dict:
            try:
                ...
                print(f"Failed to get conversation length for {sample}")
                continue
        ...
        if "mixtral" in model_args.model_name_or_path.lower():
            ...
            if "moe" in model_args.model_name_or_path.lower() or "A14B" in model_args.model_name_or_path:
                ...
                model = LlavaQwenForCausalLM.from_pretrained(
                    ...
                    low_cpu_mem_usage=False,
                    **customized_kwargs,
                    ignore_mismatched_sizes=True, #####new add
                )
...
def train(attn_implementation=None):
    ...
    ##############
    if model_args.freeze_backbone: # freeze_backbone set to True
    ...
    if model_args.vision_tower is not None:
        ...
        print(f"{'#'*23}training part {model_args.mm_tunable_parts}")
